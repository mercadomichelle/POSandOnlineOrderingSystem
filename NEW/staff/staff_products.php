...
<head>
    ...
    <link rel="stylesheet" href="../styles/staff_products.css">
</head>
<body>
<header>
    ...
    <div class="sidebar">
        <nav>
            <ul>
                ...
                <li><a href="../staff/staff_products.php" class="current"><img src="../images/products-icon.png" alt="Products">PRODUCTS</a></li>
                <li><a href="../staff/staff_stocks.php" ><img src="../images/stocks-icon.png" alt="Stocks">STOCKS</a></li>
