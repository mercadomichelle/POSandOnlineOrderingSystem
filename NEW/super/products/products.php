...
$sql = "SELECT p.prod_id, p.prod_brand, p.prod_name, p.prod_price_wholesale AS prod_price, p.prod_image_path,
...
$sql .= " GROUP BY p.prod_id, p.prod_brand, p.prod_name, p.prod_price_wholesale, p.prod_image_path";
        ...
        <div class="products">
            ...
            <div class="card">
                <div class="product-grid">
                    <div class="product-card add-new" id="addNewProductBtn" <?php echo (!$selectedBranch) ? 'style="pointer-events: none; opacity: 0.5;"' : ''; ?>>
