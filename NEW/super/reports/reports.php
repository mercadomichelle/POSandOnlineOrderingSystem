...
// Ensure branch_id is set when form is submitted
...
// Ensure that $_SESSION['selected_branch'] is set before using it
...
<body>
    ...
    <select class="branch-selector" id="branchSelector" name="branch_id" onchange="this.form.submit()">
        ...
        <option value="1" <?php echo (isset($_SESSION['selected_branch']) && $_SESSION['selected_branch'] == 1) ? 'selected' : ''; ?>>Calero</option>
        <option value="2" <?php echo (isset($_SESSION['selected_branch']) && $_SESSION['selected_branch'] == 2) ? 'selected' : ''; ?>>Bauan</option>
        <option value="3" <?php echo (isset($_SESSION['selected_branch']) && $_SESSION['selected_branch'] == 3) ? 'selected' : ''; ?>>San Pascual</option>
    </select>
</form>
    ...
    <main>
        <div class="dashboard">
            <input type="hidden" id="branch_id" value="<?php echo isset($_SESSION['branch_id']) ? $_SESSION['branch_id'] : ''; ?>" />
            ...
            <div class="upper1">
                <div class="card4">
                    ...
                    <div class="btn1">
                        <a href="data_report.php?type=wholesale&source=in-store&branch_id=<?php echo isset($_SESSION['branch_id']) ? $_SESSION['branch_id'] : ''; ?>" target="_blank">
                ...
                <div class="card5">
                    ...
                    <div class="btn1">
                        <a href="data_report.php?type=retail&source=in-store&branch_id=<?php echo isset($_SESSION['branch_id']) ? $_SESSION['branch_id'] : ''; ?>" target="_blank">
                            <button class="weekly">View Report</button></a>
                    </div>
                </div>
                ...
                <div class="card6">
                    ...
                    <div class="btn1">
                        <a href="data_report.php?type=wholesale&source=online&branch_id=<?php echo isset($_SESSION['branch_id']) ? $_SESSION['branch_id'] : ''; ?>" target="_blank">
                            <button class="weekly">View Report</button></a>
                    </div>
                </div>
